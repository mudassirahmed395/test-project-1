...
import {
  ...
  getSearchFolderRequestLoaded, getCreateFolderRequestFailed, getCreateFolderRequestLoaded, getCreateFolderRequestLoading,
...
export class MediaSandbox {
  ...
  public getCreateFolderLoading$ = this.appState.select(
    getCreateFolderRequestLoading
  );
  public getCreateFolderLoaded$ = this.appState.select(
    getCreateFolderRequestLoaded
  );
  public getCreateFolderFailed$ = this.appState.select(
    getCreateFolderRequestFailed
  );
