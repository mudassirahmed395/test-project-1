...
export class MediaService extends Api {
  ...
  CreateFolder(param): Observable<any> {
    return this.http.post(
      (this.url = this.getBaseUrl() + '/media/vendor-create-folder'),
      param
    );
  }
  ...
  bucketLists(param): Observable<any> {
    return this.http.get(
      (this.url = this.getBaseUrl() + '/media/vendor-bucket-object-list'),
      { params: param }
    );
  }
  ...
  searchFolder(param): Observable<any> {
    return this.http.get(
      (this.url = this.getBaseUrl() + '/media/vendor-search-folder'),
      { params: param }
    );
  }
}
