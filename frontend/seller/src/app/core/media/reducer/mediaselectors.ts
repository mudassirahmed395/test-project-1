...
export const getCreateFolderRequestLoading = createSelector(
  getAddmediaState,
  fromMedia.getCreateFolderRequestLoading
);
export const getCreateFolderRequestLoaded = createSelector(
  getAddmediaState,
  fromMedia.getCreateFolderRequestLoaded
);
export const getCreateFolderRequestFailed = createSelector(
  getAddmediaState,
  fromMedia.getCreateFolderRequestFailed
);
