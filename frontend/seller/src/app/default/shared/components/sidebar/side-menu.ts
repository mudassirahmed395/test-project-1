...
//       {
//         path: '/sales',
//         title:"{{'Dashboard.Sales'|translate}}",
...
//   {
//     path: '/catalog',
//     title:"{{'Dashboard.Catalog'|translate}}",
...
//   {
//     path: '/marketing',
//     title: "{{'Dashboard.Marketing'|translate}}",
...
//   {
//     path: '/reports',
//     title: "{{'Dashboard.Report'|translate}}",
