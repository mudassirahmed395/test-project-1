...
export class BannerService extends Api {
  ...
  public bannerList(params: BannerlistModel): Observable<any> {
    let reqOpts: any = {};
    reqOpts = params;
    return this.http.get(this.url + '/banner', { params: reqOpts });
  }
  ...
  public updateBanner(param: BannerupdateModel, Id: number): Observable<any> {
    return this.http.put(this.url + '/banner/' + Id, param);
  }

  // add
  addBanner(param: BanneraddModel) {
    return this.http.post(this.url + '/banner', param);
  }

  // delete
  public deleteBanner(param: any, Id: number): Observable<any> {
    return this.http.delete(this.url + '/banner/' + Id, param);
  }
 ...
 /*category List*/
  ...
  public categoryLists(params): Observable<any> {
    return this.http.get(this.url + '/category', {params: params});
  }
