...
import { getNewSizeChart, getSizeChart, sizechartList, SizeChartListLoading, SizeChartListLoaded, SizeChartListFailed, varientList, attributeList, headerTextList, headerText, createHeaderTextLoading, createHeaderTextLoaded, deleteHeaderTextLoader, updateHeaderText, updateHeaderTextLoading, updateHeaderTextLoaded, updateHeaderTextFailed, deleteChartLoaded } from '../sizechart/sizechart-reducer/sizechart.selector';
...
export class SizeChartSandbox {
  ...
  public attributeList(value: any) {
    this.appState.dispatch(
      new SizeChartaction.DoAttributeListAction((value))
    );
  }
