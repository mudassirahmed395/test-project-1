...
export const initialState: ZoneState = new ZoneRecordState() as unknown as ZoneState;
...
export const newZone = (state: ZoneState) => state.newZone;
export const updateZone = (state: ZoneState) => state.updateZone;
export const zoneDelete = (state: ZoneState) => state.zoneDelete;
export const zoneList = (state: ZoneState) => state.zoneList;
export const zonePagination = (state: ZoneState) => state.zonePagination;
