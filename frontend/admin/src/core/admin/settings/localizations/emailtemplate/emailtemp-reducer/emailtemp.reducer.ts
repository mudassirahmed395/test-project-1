...
export const initialState: EmailTempState = new EmailTempRecordState() as unknown as EmailTempState;
...
export const updateEmailTemp = (state: EmailTempState) =>
  state.updateEmailTemp;
export const emailTempDelete = (state: EmailTempState) =>
  state.emailTempDelete;
export const emailTempList = (state: EmailTempState) => state.emailTempList;
export const emailTempPagination = (state: EmailTempState) =>
