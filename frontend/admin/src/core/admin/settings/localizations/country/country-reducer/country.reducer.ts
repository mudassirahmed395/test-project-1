...
export const initialState: CountryState = new CountryRecordState() as unknown as CountryState;
...
export const getUpdateCountryLoaded = (state: CountryState) => state.updateCountryLoaded;
export const getDeleteCountry = (state: CountryState) => state.countryDelete;
export const countryList = (state: CountryState) => state.countryList;
