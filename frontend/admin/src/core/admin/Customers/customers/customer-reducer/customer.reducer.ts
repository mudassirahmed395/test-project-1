...
export function reducer(state = initialState, { type, payload }: any): CustomerState {
    ...
    switch (type) {
        ...
        case actions.ActionTypes.GET_CUSTOMER_EXCEL: {
            return Object.assign({}, state, {
                exportLoading: true,
                exportLoaded: false,
            });
        }
        case actions.ActionTypes.GET_CUSTOMER_EXCEL_SUCCESS: {
            return Object.assign({}, state, {
                exportLoading: false,
                exportLoaded: true,
            });
...
export const exportExcelLoading = (state:CustomerState)=> state.exportLoading;
