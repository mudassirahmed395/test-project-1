...
export const orderListLoading = createSelector(getorderState,fromsalesorder.orderListLoading);
...
export const orderExcelLoading = createSelector(getorderState,
  fromsalesorder.orderExcelLoading)
