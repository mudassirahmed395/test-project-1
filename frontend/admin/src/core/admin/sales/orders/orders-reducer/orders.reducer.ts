...
export function reducer(
  ...
  // <------------------ORDER LIST COUNT--------------------> //
   ...
   // <------------------ ORDER LOG --------------------> //
    ...
    // <----- order excel --->
    case actions.ActionTypes.GET_ORDER_EXCEL:{
      return Object.assign({},state,{
    ...
    case actions.ActionTypes.GET_ORDER_EXCEL_SUCCESS:{
      return Object.assign({},state,{
...
//
export const orderExcelLoading =(state:SalesOrderState)=> state.orderExcelLoading;

export const orderList = (state: SalesOrderState) => state.orderList;
export const orderListLoading = (state: SalesOrderState) => state.orderListLoading
