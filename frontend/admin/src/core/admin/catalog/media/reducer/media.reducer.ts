...
export function reducer(state = initialState, { type, payload }: any): Media {
  ...
  switch (type) {
    ...
    // BULK IMAGE UPLOAD
    case actions.ActionTypes.BULK_IMAGE_UPLOAD: {
      return Object.assign({}, state, {
        bulkImageUploadLoading: true,
        bulkImageUploadLoaded: false,
        bulkImageUploadFailed: false
      });
    }

    case actions.ActionTypes.BULK_IMAGE_UPLOAD_SUCCESS: {
      return Object.assign({}, state, {
        bulkImageUpload: payload,
        bulkImageUploadResponse: true,
        bulkImageUploadLoading: false,
        bulkImageUploadLoaded: false,
        bulkImageUploadFailed: false
      });
    }

    case actions.ActionTypes.BULK_IMAGE_UPLOAD_FAIL: {
      return Object.assign({}, state, {
        bulkImageUploadLoading: false,
        bulkImageUploadLoaded: true,
        bulkImageUploadFailed: true
      });
    }


    // BULK IMAGE DELETE
    case actions.ActionTypes.BULK_IMAGE_DELETE: {
      return Object.assign({}, state, {
        bulkImageDeleteLoading: true,
        bulkImageDeleteLoaded: false,
        bulkImageDeleteFailed: false
      });
    }

    case actions.ActionTypes.BULK_IMAGE_DELETE_SUCCESS: {
      return Object.assign({}, state, {
        bulkImageDelete: payload,
        bulkImageDeleteLoading: false,
        bulkImageDeleteLoaded: false,
        bulkImageDeleteFailed: false
      });
    }

    case actions.ActionTypes.BULK_IMAGE_DELETE_FAIL: {
      return Object.assign({}, state, {
        bulkImageDeleteLoading: false,
        bulkImageDeleteLoaded: true,
        bulkImageDeleteFailed: true
      });
    }
...
export const bulkImageUpload = (state: Media) => state.bulkImageUpload;
export const bulkImageUploadLoading = (state: Media) => state.bulkImageUploadLoading;
export const bulkImageUploadLoaded = (state: Media) => state.bulkImageUploadLoaded;
export const bulkImageUploadFailed = (state: Media) => state.bulkImageUploadFailed;

export const bulkImageDelete = (state: Media) => state.bulkImageDelete;
export const bulkImageDeleteLoading = (state: Media) => state.bulkImageDeleteLoading;
export const bulkImageDeleteLoaded = (state: Media) => state.bulkImageDeleteLoaded;
export const bulkImageDeleteFailed = (state: Media) => state.bulkImageDeleteFailed;
